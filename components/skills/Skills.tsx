...
const Skills = () => {
  return (
    <section className="min-h-screen overflow-auto px-4 sm:px-16 xl:px-28 2xl:px-52 py-8 2xl:py-12 flex flex-col">
      <h1 className="text-4xl text-green-700 font-extrabold leading-9 tracking-tight sm:text-4xl sm:leading-10 md:text-6xl md:leading-14 pb-12">
        Skills
      </h1>
      <div className="pb-12">
      ...
      <section className="flex flex-col space-y-6 lg:space-y-0 lg:flex-row lg:space-x-8">
        <div className="flex flex-col space-y-6 lg:basis-1/2">
          <p className="xl:text-2xl font-semibold self-center">
            Programming Languages
          </p>
          <div className="w-[350px] sm:w-[400px] self-center xl:w-full">
            <figure>
      ...
      <section className="flex flex-col space-y-6 lg:space-y-0 lg:flex-row lg:space-x-8 pt-8 xl:self-center">
        <div className="flex flex-col space-y-6 lg:basis-1/2">
