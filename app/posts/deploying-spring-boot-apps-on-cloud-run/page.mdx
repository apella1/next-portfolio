...
<div className="my-8">
    ...
    <ul className="space-y-2">
        <li>
            <a href="#prerequisites-setup" className="text-blue-600 dark:text-blue-400 hover:underline">Prerequisites
                Setup</a>
        </li>
        <li>
            <a href="#spring-boot-application-configuration"
               className="text-blue-600 dark:text-blue-400 hover:underline">Spring Boot Application Configuration</a>
        </li>
        <li>
            <a href="#the-dockerfile" className="text-blue-600 dark:text-blue-400 hover:underline">The Dockerfile</a>
        </li>
        <li>
            <a href="#common-port-issues" className="text-blue-600 dark:text-blue-400 hover:underline">Common Port
                Issues and Solutions</a>
        </li>
        <li>
            <a href="#building-and-pushing" className="text-blue-600 dark:text-blue-400 hover:underline">Building and
                Pushing to Container Registry</a>
        </li>
        <li>
            <a href="#database-configuration" className="text-blue-600 dark:text-blue-400 hover:underline">Database
                Configuration</a>
            <ul className="ml-4 mt-2 space-y-2">
                <li>
                    <a href="#cloud-sql-connection" className="text-blue-600 dark:text-blue-400 hover:underline">Cloud
                        SQL Connection</a>
                </li>
                <li>
                    <a href="#external-database-connection"
                       className="text-blue-600 dark:text-blue-400 hover:underline">External Database Connection</a>
                </li>
            </ul>
        </li>
        <li>
            <a href="#monitoring-and-logging" className="text-blue-600 dark:text-blue-400 hover:underline">Monitoring
                and Logging</a>
        </li>
        <li>
            <a href="#networking-between-services" className="text-blue-600 dark:text-blue-400 hover:underline">Networking
                Between Services</a>
        </li>
        <li>
            <a href="#deployment-to-cloud-run" className="text-blue-600 dark:text-blue-400 hover:underline">Deployment
                to Cloud Run</a>
        </li>
        <li>
            <a href="#common-issues" className="text-blue-600 dark:text-blue-400 hover:underline">Common Issues and
                Troubleshooting</a>
        </li>
        <li>
            <a href="#resources" className="text-blue-600 dark:text-blue-400 hover:underline">Resources for Further
                Reading</a>
        </li>
    </ul>
</div>
